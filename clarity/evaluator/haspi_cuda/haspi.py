from clarity.evaluator.haspi_cuda import eb, ebm, ip


def haspi_v2_cuda(x, fx, y, fy, HL, Level1=65):
    """
...
def haspi_v2_be_cuda(
    ...
    score_l, _ = haspi_v2_cuda(xl, fs_signal, yl, fs_signal, HL_l, Level)
    score_r, _ = haspi_v2_cuda(xr, fs_signal, yr, fs_signal, HL_r, Level)
